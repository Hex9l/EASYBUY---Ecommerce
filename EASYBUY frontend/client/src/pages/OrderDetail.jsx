...
const OrderDetail = () => {
    ...
    return (
        <div className='bg-white min-h-screen'>
            {/* Header */}
            <div className='sticky top-0 z-20 bg-white p-4 flex items-center gap-4'>
                <button
                    onClick={() => navigate(-1)}
                    className='w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center text-gray-600 hover:bg-gray-100'
                >
                    <FaArrowLeft />
                </button>
            </div>
            ...
            <div className='max-w-2xl mx-auto px-6 pb-20'>
                {/* Order Summary Title */}
                <div className='mb-6'>
                    <h1 className='text-2xl font-black text-gray-800'>Order summary</h1>
                    <p className='text-gray-500 text-sm'>Arrived at {formattedTime}</p>
                    <button 
                        onClick={handleDownloadInvoice}
                        className='flex items-center gap-1 text-green-600 text-sm font-bold mt-1 hover:text-green-700 transition-colors'
                    >
                ...
                {/* Items Section */}
                <div className='mb-8'>
                    <h3 className='text-sm font-bold text-gray-800 mb-4'>{orderItems.length} items in this order</h3>
                    <div className='space-y-6'>
                        {orderItems.map((item, index) => (
                            <div key={index} className='flex items-center gap-4'>
                                <div className='w-16 h-16 bg-gray-50 border border-gray-100 rounded-xl p-2 flex items-center justify-center overflow-hidden'>
                                    <img
                                ...
                                <div className='flex-1'>
                                    <h4 className='text-sm font-bold text-gray-800 line-clamp-1'>{item.product_details?.name}</h4>
                ...
                {/* Order Details Grid */}
                <div className='mb-8'>
                    <h3 className='text-base font-black text-gray-800 mb-4'>Order details</h3>
                    <div className='space-y-5'>
                        <div>
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <button onClick={() => copyToClipboard(orderId)} className='text-gray-400 hover:text-gray-600'>
                                    <FaCopy size={12} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div>
                            <p className='text-[10px] uppercase tracking-wider text-gray-400 mb-1'>Payment</p>
                        ...
                        <div>
                            <p className='text-[10px] uppercase tracking-wider text-gray-400 mb-1'>Deliver to</p>
                        ...
                        <div>
                            <p className='text-[10px] uppercase tracking-wider text-gray-400 mb-1'>Order placed</p>
                            <p className='text-sm font-medium text-gray-600'>placed on {formattedDate}, {formattedTime}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Help Section */}
                <div>
                    <h3 className='text-base font-black text-gray-800 mb-4'>Need help with your order?</h3>
                    <button className='w-full flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div className='text-left'>
                                <p className='text-sm font-black text-gray-800'>Chat with us</p>
