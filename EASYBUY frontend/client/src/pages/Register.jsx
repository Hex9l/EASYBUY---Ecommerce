...
const Register = () => {
  ...
  >
    {/* Title */}
    <p className="text-center text-lg md:text-2xl font-semibold mb-4 md:mb-6">
      Welcome to <span className="text-green-600">EASYBUY</span>
    </p>
    ...
    <form className="grid gap-3 md:gap-4" onSubmit={handleSubmit}>
      ...
      {/* Name */}
      <div>
        <label htmlFor="name" className="block font-medium text-xs md:text-base mb-1">Name:</label>
        <input
          type="text"
          id="name"
          autoFocus
