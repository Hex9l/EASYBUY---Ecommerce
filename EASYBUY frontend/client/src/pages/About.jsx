    ...
    return (
        <div className="bg-white min-h-screen">
            <div className="container mx-auto px-4 py-8 lg:py-12 max-w-4xl">
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">About Us</h1>

                <section className="mb-8">
                    <p className="text-gray-600 leading-relaxed mb-4">
                        Welcome to <span className="font-bold text-black">EasyBuy</span>, your number one source for all things groceries and daily essentials. We're dedicated to allowing you to focus on the things that matter by taking care of your shopping needs with a focus on dependability, customer service, and uniqueness.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
