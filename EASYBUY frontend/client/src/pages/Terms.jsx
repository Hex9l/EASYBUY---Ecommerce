    ...
    return (
        <div className="bg-white min-h-screen">
            <div className="container mx-auto px-4 py-8 lg:py-12 max-w-4xl">
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Terms & Conditions</h1>
                ...
                <div className="space-y-8 text-gray-600 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-800 mb-3">2. Use of Service</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-800 mb-3">3. Orders and Delivery</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-800 mb-3">4. Pricing and Payment</h2>
                        <p>
